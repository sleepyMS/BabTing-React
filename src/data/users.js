...
const users = [
    ...
    myPosts: [
      {
        ...
        likes: 5,
        comments: [
          { userId: 2, content: "저 함께 하고 싶어요!", date: "2024-11-24" },
          { userId: 3, content: "시간이 어떻게 되세요?", date: "2024-11-24" },
        ],
      },
      {
        id: 2,
        ...
        likes: 8,
        comments: [
          { userId: 3, content: "참여하고 싶습니다!", date: "2024-11-23" },
        ],
      },
    ],
    myComments: [
      { postId: 3, content: "저 참여하고 싶습니다!", date: "2024-11-22" },
      { postId: 5, content: "정보 감사합니다.", date: "2024-11-21" },
    ],
    timetable: [
    ...
    reviews: [
      {
        ...
        likes: 12,
        comments: [
          { userId: 2, content: "저도 가보고 싶어요!", date: "2024-11-25" },
          { userId: 3, content: "위치가 어디인가요?", date: "2024-11-25" },
        ],
      },
    ],
    meetings: [
  ...
  },
  {
    ...
    myComments: [
      { postId: 1, content: "저 함께 하고 싶어요!", date: "2024-11-24" },
    ],
    timetable: [
    ...
    reviews: [
      {
        ...
        likes: 8,
        comments: [
          { userId: 1, content: "사진이 예뻐요!", date: "2024-11-23" },
        ],
      },
    ],
    meetings: [
    ...
    myPosts: [
      {
        id: 4,
        title: "함께 운동하실 분!",
        content: "축구 같이 하실 분 구합니다.",
        date: "2024-11-21",
        likes: 7,
        comments: [
          { userId: 2, content: "저도 참여하고 싶어요!", date: "2024-11-21" },
        ],
      },
    ],
    myComments: [
      { postId: 2, content: "스터디에 참여하고 싶습니다!", date: "2024-11-23" },
    ],
    timetable: [
    ...
    reviews: [
      {
        ...
        likes: 5,
        comments: [
          { userId: 1, content: "다음에 같이 가요!", date: "2024-11-22" },
        ],
      },
    ],
    meetings: [
    ...
    myPosts: [
      {
        ...
        likes: 4,
        comments: [
          { userId: 2, content: "좋은 정보 감사합니다.", date: "2024-11-21" },
        ],
      },
    ],
    myComments: [],
    ...
    reviews: [
      {
        ...
        likes: 9,
        comments: [
          { userId: 3, content: "한번 가보고 싶네요!", date: "2024-11-21" },
        ],
      },
    ],
    meetings: [
    ...
    myPosts: [
      {
        ...
        date: "2024-11-20",
        likes: 6,
        comments: [{ userId: 4, content: "관심 있어요!", date: "2024-11-20" }],
      },
    ],
    myComments: [
      { postId: 5, content: "디자인에 관심 있습니다.", date: "2024-11-21" },
    ],
    timetable: [
    ...
    reviews: [
      {
        ...
        likes: 7,
        comments: [
          { userId: 2, content: "저도 가보고 싶어요!", date: "2024-11-20" },
        ],
      },
    ],
    meetings: [
